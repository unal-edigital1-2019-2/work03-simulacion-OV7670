...
## TRABAJO 03- Simulaciòn de HDL para la cámara OV7670


## Introducción 
Este paquete de trabajo incluye  el testbench de bloque de captara de daos de la camara en el formato RGB 565 y genrar un archivo de texto plano que contiene los datos de salida de la pantalla VGA, para su posterio simulaciòn

Se propone el siguiente esquema de trabajo, donde el estudiante puede testear el funcionamiento del driver de la cámara diseñado y visualizar la salida  en el simulador VGA [link](https://ericeastwood.com/lab/vga-simulator/) 
...
2. En las propiedades de simulaciòn modificar el tiempo de simulación a 30ms. y generar la simulaciòn
...
***Nota:*** Observe que en esta instancia usted no ha modificado el hardware del proyecto. y por lo tanto, lo que observa, es la visualizaciòn en la pantalla VGA simulada, es la imagen almacenada en memoria por defecto.
...
8. Al terminar de decribir la adquisión de la cámara  repita los paso del 2 a 6.  Si el resultado es el que se observa en la imagen siguiente, indica que el módulo cam_read es adecuada  y por lo tanto, se dara pr terminado este paquete de trabajo, de lo contrario  vuelta al punto 7

![resultado2](./docs/figs/resultado2.png)

la imagen muestra que se adquirio una  foto de color rojo.
